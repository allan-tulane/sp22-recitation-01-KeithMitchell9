...
**The work is O(n) and the span is O(lg(n))**


5. Why are we going through all this trouble? Couldn't I just use this function to count words?

**The work of the following problem is O(n^2), making it far more efficient to use the reduce function.**
...
**The fact that it is a sequential counter. The nested loop iterates through every item and takes user of a counter making something such as parallelizing difficult as each counter would be different**
